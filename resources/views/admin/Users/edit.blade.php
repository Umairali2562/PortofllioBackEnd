        ...
        <script>
            $(document).ready(function () {
                ...
                $('#role').on('change', function () {
                    ...
                    $.ajax({
                        ...
                        $.each(data, function (index, element) {
                            var isChecked = userHasPermission(element.id);

                            $(permissions_ckeckbox_list).append(
                                '<div class="custom-control custom-checkbox">' +
                                '<input style="margin-right: 6px" class="custom-control-input" type="checkbox" name="permissions[]" id="' + element.slug + '" value="' + element.id + '" ' + (isChecked ? 'checked="checked"' : '') + '>' +
                ...
                function userHasPermission(permissionId) {
                    ...
                    return @json($userPermissions->pluck('id')->toArray()).includes(permissionId);
                }
            });
        </script>
    @endsection
